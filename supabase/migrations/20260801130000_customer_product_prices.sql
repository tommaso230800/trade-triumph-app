-- Prezzo riservato cliente + azienda + prodotto. Contiene SOLO prezzi impostati
-- intenzionalmente: il prezzo di listino resta su prodotti.prezzo_listino,
-- l'ultimo prezzo applicato resta calcolato dallo storico ordini.
