    ...
    extend: {
      ...
      colors: {
        ...
        scatto: {
          ...
          surface: "hsl(var(--scatto-surface))",
          ink: "hsl(var(--scatto-ink))",
          muted: "hsl(var(--scatto-muted))",
          line: "hsl(var(--scatto-line))",
          accent: "hsl(var(--scatto-accent))",
          success: "hsl(var(--scatto-success))",
      ...
      animation: {
        ...
        "scale-in-bounce": "scale-in-bounce 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) both",
